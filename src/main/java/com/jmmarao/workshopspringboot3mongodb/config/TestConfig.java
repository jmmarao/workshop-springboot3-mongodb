...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, simpleDateFormat.parse("21/03/2023"), "Planning my next vacation", "I'm going to Brazil", user1);
        Post post2 = new Post(null, simpleDateFormat.parse("25/02/2023"), "Defeat Thanos", "Remember when I defeated Thanos? What happened?", user1);
